...
public class Weather {
	...
	public String toString() {
		return "Weather [description=" + description + ", country=" + country + ", city=" + city + ", temperature="
				+ temperature + ", minTemperature=" + minTemperature + ", maxTemperature=" + maxTemperature
				+ ", humidity=" + humidity + ", pressure=" + pressure + ", windDegree=" + windDegree + ", windSpeed="
				+ windSpeed + "]";
	}
